...
/**
 * Declares that an Observable object does not hold strong references to observers registered with it.
 * Observers are therefore required to manage their own reference lifespans. For an observer that holds a
